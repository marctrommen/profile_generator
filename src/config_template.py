...
def configuration():
    ...
    config["TEMPLATE_FILES"] = [
        ...
        ("skill_item_one_dot_filled.html", "SKILLS_GROUP_ITEM_ONE_DOT_TEMPLATE"),
        ("skill_item_two_dots_filled.html", "SKILLS_GROUP_ITEM_TWO_DOTS_TEMPLATE"),
        ("skill_item_three_dots_filled.html", "SKILLS_GROUP_ITEM_THREE_DOTS_TEMPLATE"),
